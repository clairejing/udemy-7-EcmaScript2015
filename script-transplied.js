...
// question.set('question', 'What is the offical name of the lastest major JS version?')
// question.set(1, 'ES5')
// question.set(2, 'ES6')
...
var allParks = [new Park('Green Park', 1987, 0.2, 215), new Park('National Park', 1893, 2.9, 3541)];
...
function reportStreets(s) {
    ...
    var _calc = calc(s.map(function (el) {
        return el.length;
    })),
        _calc2 = _slicedToArray(_calc, 2),
        totalLength = _calc2[0],
        avgLength = _calc2[1];
