...
const allParks = [new Park('Green Park', 1987, 0.2, 215), new Park('National Park', 1893, 2.9, 3541)]
...
function calc(arr) {
    const sum = arr.reduce((prev, cur, index) => pre = pre + cur, 0)
